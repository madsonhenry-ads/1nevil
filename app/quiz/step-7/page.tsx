...
function Step7Content() {
  ...
  return (
    <QuizLayout step={4} totalSteps={26}>
      {" "}
      {/* Usar QuizLayout para a barra de progresso, agora na etapa 4/26 */}
      {/* Custom header for quiz pages - modified for step 7 */}
      <header className="w-full px-6 py-4 flex justify-between items-center absolute top-0 left-0 right-0 bg-[#f5f3f0] z-10">
        ...
        <span className="text-gray-600 text-sm font-medium">4/26</span>
      </header>
