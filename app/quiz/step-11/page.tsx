...
function Step11Content() {
  ...
  return (
    <QuizLayout step={8} totalSteps={26}>
      {" "}
      {/* Usar QuizLayout para a barra de progresso, agora na etapa 8/26 */}
