...
function Step13Content() {
  ...
  return (
    <QuizLayout step={10} totalSteps={26}>
      {" "}
      {/* Usar QuizLayout para a barra de progresso, agora na etapa 10/26 */}
      <header className="w-full px-6 py-4 flex justify-between items-center absolute top-0 left-0 right-0 bg-[#f5f3f0] z-10">
        ...
        <span className="text-gray-600 text-sm font-medium">10/26</span>
      </header>
      <main className="flex flex-col items-center justify-center px-6 py-12 max-w-2xl mx-auto min-h-screen">
        <div className="text-center space-y-2 mb-12">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
            I often struggle to pursue my ambitions due
            <br />
            to fear of messing up and failing
          </h1>
