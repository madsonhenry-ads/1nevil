...
function Step12Content() {
  ...
  // Cálculo da porcentagem de progresso (step 9 de 26)
  const progressPercentage = (9 / 26) * 100
  ...
  return (
    <QuizLayout>
      ...
      <header className="w-full px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center bg-[#f5f3f0] flex-shrink-0">
        ...
        <span className="text-gray-600 text-xs sm:text-sm font-medium">9/26</span>
      </header>
